...
abstract class AIdResource<T extends AUuidData> extends AResource {
  ...
  @protected
  Future<IdResponse> createWithCatch(T t, {List<MediaMessage> mediaMessages}) => catchExceptionsAwait(() async {
    String output;
    ...
    if(idModel is model.AFileUploadModel<T>) {
      final model.AFileUploadModel<T> fileModel = idModel as model.AFileUploadModel<T>;
