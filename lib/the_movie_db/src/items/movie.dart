...
class Movie extends AItem {
  ...
  //  ],
  //  status: "Released",
  //  tagline: "John Crichton may not have started the war - but only he can end it.",
